 ...
 * @author User
 */
public class TelaLoginAtendimento extends javax.swing.JFrame {

    /**
     * Creates new form TelaInitial
     */
    public TelaLoginAtendimento() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLoginAtendimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLoginAtendimento().setVisible(true);
            }
        });
    }
